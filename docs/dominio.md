...
| Fin discrepante | Existen declaraciones no coincidentes y no hay ninguna confirmación definitiva, ni automática ni administrativa. | Cliente y Personal pueden modificar su propia declaración mientras no exista confirmación; Administración puede fijar el definitivo. | Si pasan a coincidir según D05, el sistema confirma sin aprobación manual; alternativamente, Administración cierra directamente. Después de cualquiera de las dos confirmaciones deja de ser «Fin discrepante». |
...
| Administración | Plaza concreta sin asignación vigente | Asignar Personal | Solicitud pendiente sin cobertura o parcialmente cubierta | Permitido; no concede al Cliente permisos de edición ni resuelve D03 o D07. |
...
| Cierre administrativo directo | Administración fija el valor definitivo sin esperar ambas declaraciones, incluso si existen declaraciones diferentes; quedan valor, procedencia, autor y momento. Desde esa confirmación, Cliente y Personal ya no pueden editar sus declaraciones aunque sigan siendo distintas. | PDF pp. 3–4; trazabilidad del encargo. | D04 afecta la representación temporal. |
